function avg_psth_PV(cellids1,cellids2,responsespec,resdir,spike)
%AVG_PSTH_PV   Average normalized peri-event time histograms.
%   AVG_PSTH_PV(CELLIDS1,CELLIDS2,RESPONSESPEC, RESDIR) calculates normalized
...
%   averaging.
%
%   AVG_PSTH_PV(CELLIDS,CELLIDS,RESPONSESPEC,'BURST') compares the PSTHs of
...
set(gca,'YLim',[min(mean(psth_R2))-5 max(mean(psth_R1))+5]);
